...
// ⬇️ Use your actual asset paths here
const PERIODS = [
    {
        key: 'Weekly',
        label: 'Weekly',
...
export default function GroupTopVolumeScreen({ navigation }) {
    ...
    const TopItem = ({ index, item }) => {
        ...
        const containerStyle = [
            styles.topItem,
            is1 && styles.topItemGold,
            (is2 || is3) && styles.topItemPurple,
            is3 && styles.topItemThird,
        ];
...
const styles = StyleSheet.create({
    ...
    periodIconActive: { width: 80, height: 60, opacity: 1 , marginTop:10,}, // bigger when active
    ...
    topItemGold: { borderColor: '#D7BF5A', backgroundColor: '#1A150B' },
    topItemPurple: { backgroundColor: '#211A2F', borderColor: '#5E3CC5' },
    topItemThird: { borderColor: '#BFBFBF' },
